...
import com.aih.pagepilot.mapper.AppMapper;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    @Override
    public boolean hasPermission(App app, HttpServletRequest request) {
        ...
        try {
            ...
            // 普通用户只能操作自己的应用
            return app.getUserId() != null && app.getUserId().equals(loginUser.getId());
        } catch (Exception e) {
            return false;
        }
    }
